...
## What if there’s a bug in AiBlocks’s code?
...
## Securing a AiBlocks Core Instance

It’s generally a good idea to make sure access to AiBlocks Core is extremely limited. Make sure only the ports needed to communicate with Millennium and other AiBlocks Core instances on the public network are open. Access to AiBlocks Core’s databases should also be highly restricted.


## Keep Up to Date with Security Patches

Make sure that you’re using the most secure software available by keeping up-to-date with the latest releases. AiBlocks.io publishes release announcements on a mailing list you can subscribe to by emailing [aiblocks-dev+subscribe@googlegroups.com](mailto:aiblocks-dev+subscribe@googlegroups.com).
